...
@section('content')
    ...
    <div class="container my-3">
        <div id="successAlert" class="alert alert-success alert-dismissible fade show" role="alert" style="display: none;">
            <strong>Success!</strong> Service content updated successfully.
    ...
    <div class="container mt-4">
        <h2>Update Service Content</h2>
        <form id="updateForm">
            <div class="mb-3">
                <label for="headingText" class="form-label">Service Heading Text:</label>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#updateForm').on("submit", function (e) {
                ...
                $.ajax({
                    url: '/api/headings/1/service',
                    method: 'PATCH',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content'),
                    },
                    data: { service: headingText },
                })
                .done(function () {
                    $('#successAlert').show();
                ...
                .fail(function () {
                    console.error('Error updating service content.');
